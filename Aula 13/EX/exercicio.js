// aprendendo funcionalidades com strings 

const nome = prompt("Digite eu nome completo:");
...
document.body.innerHTML += `Seu nome com letras minúscula: <strong>${nome.toLowerCase()}</strong></br>`;